<div class="nav-wrapper">
	...
	<li id="dashboard-link"><?php echo anchor('http://sistema.difasa.com.mx/panelv2.php','<i class="zmdi zmdi-home"></i> <span class="ng-scope">'.'Dashboard' /*lang('global:dashboard')*/.' </span>', 'class="md-button md-ink-ripple top-link '.( true ? 'current ' : '').'"') ?></li>
